...
export const formSchema = z.object({
  ...
  contact: z.string().min(3, { message: "Please enter your contact number." }),
        ...
        <div className="w-full max-w-7xl flex flex-col-reverse md:flex-row gap-10">
          <div className="flex-1 flex flex-col  space-y-4">
            <h2 className="text-3xl font-bold text-gray-800 leading-snug mt-4">
              Hotel Supply & Hospitality 2026
            </h2>
            <p className="text-gray-600 text-sm leading-relaxed max-w-md">
              Step into a vibrant hub where global industries, visionary
              leaders, and cultural showcases come together. At the Hotel Supply
              & Hospitality 2026, discover new markets, forge powerful
              connections, and experience the future of collaboration across
              Asia and beyond.
            </p>
            ...
            <div className="w-full aspect-video mt-4">
              <iframe
                ...
                title="Hotel Supply & Hospitality 2026"
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    {[
                      ...
                      <div key={name} className="flex flex-col gap-1">
                        <Label
                          htmlFor={name}
                          className="text-sm text-gray-700 font-medium pb-2"
                        >
                          {label}
                ...
                <Card className="w-full max-w-md shadow-xl border border-gray-200">
                  <CardContent className="py-14 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-sm text-gray-600 max-w-sm mt-2">
                      Thank you! Your registration has been received. You will
                      receive your badge email once your request is approved.
                    </p>
                  </CardContent>
                </Card>
              </div>
